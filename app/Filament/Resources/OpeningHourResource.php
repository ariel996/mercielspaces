...
class OpeningHourResource extends Resource
{
        ...
        return $form
            ->schema([
                Forms\Components\TextInput::make('working_day')
                    ...
                    ->maxLength(255),
                Forms\Components\TextInput::make('working_hour')
                    ->placeholder('14h - 18h ou FERME')
                    ->required()
                    ->maxLength(255),
            ]);
    }
        ...
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('working_day')
                    ->searchable(),
                Tables\Columns\TextColumn::make('working_hour')
                    ->searchable(),
    ...
    {
        return [
            'index' => Pages\ManageOpeningHours::route('/'),
        ];
    }
}
